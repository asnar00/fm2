...
The apply ritual's eviction was a sledgehammer — `caches.delete('muon')`
...
`localStorage.muonHashes`. An instance that has never seen one learns
...
`caches.delete('muon')`, then store what was fetched.
