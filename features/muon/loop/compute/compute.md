# compute
*muon computes for itself: a WebGPU substrate of our own — WGSL in, numbers out, no dependencies*
...
Muon grows its own compute substrate. Not a framework adopted, not a
...
Nothing to see yet — this is muon growing the organ it will think with.
When tools start answering instantly on your phone with the network
off, this is what's underneath.

## glossary

- **compute substrate**: muon's own WebGPU driver + the WGSL kernels of
