...
A future ground change bumps the tag: `g=2` on 2026-09-02, when the ground became Stadia's Alidade Smooth (`MISO_TILE_URL` in the mini's plist; ash chose it from an audition, self-check #p41); `g=3` the same afternoon for Alidade Smooth Dark — the tool buttons did not pop on the grey (#p43).
