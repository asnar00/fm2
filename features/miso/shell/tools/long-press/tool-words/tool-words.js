...
const feature_ToolWords = {
  ...
  BUTTONS: {
    ...
    invite_qr: { name: 'QR code', intro: 'One code for the room: pick the role, show it, everyone scans and types their own name and number.' },
    invite_name: { name: 'by name', intro: 'Type a name and number and pick a role; they get a code by text.' },
