...
// verbatim library — full Rust, outside the chain machinery. See journal.md.
...
pub fn fm_journal_arm(state: &str) {
...
pub fn fm_journal_on(path: &str) -> bool {
...
pub fn fm_journal_drain() -> Vec<serde_json::Value> {
